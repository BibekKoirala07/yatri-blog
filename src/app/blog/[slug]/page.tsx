...
function BlogPosts({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 rounded-xl px-4 py-12">
      <div className="max-w-3xl  mx-auto">
        <div className=" flex mb-7 align-middle justify-between">
          <Link
            href="/"
            className="flex items-center text-blue-600 hover:text-blue-800group"
          >
            <svg
